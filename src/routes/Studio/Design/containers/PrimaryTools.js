  ...
  render () {
    ...
    return (
      <div className='wrapper'>
        ...
        <Button ripple onClick={undo} style={{ marginLeft: '5px' }}>undo<i className='material-icons'>undo</i></Button>
        ...
        <Button ripple style={{ position: 'absolute', right: '5px' }}>
          Preview Experiment<i className='material-icons'>play_arrow</i>
        </Button>
      </div>
    )
  }
